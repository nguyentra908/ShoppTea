...
export default class ProductDetails extends Component {
  ...
  render() {
    const staticClass =
      "product_favorite d-flex flex-column align-items-center justify-content-center";
          ...
          <div className="breadcrumbs d-flex flex-row align-items-center">
            <ul>
              ...
              <li>
                <a
                  onClick={() => {
                    this.onRouteChanged("/categories");
                  }}
                >
          ...
          <div className="col-lg-5">
            <div className="product_details">
              ...
              <div className="product_color">
                ...
                <ul>
                  <li
                    style={{ background: product.color, border: "0.5px solid" }}
                  ></li>
                </ul>
              </div>
              <div className="product_color">
