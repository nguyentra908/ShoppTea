...
import {
  ...
  SET_LIST_PRODUCT_PAGINATION,
  RESET_LIST_PRODUCT_PAGINATION,
...
class CategoryPage extends Component {
  ...
  onFilterClicked = () => {
    ...
    const filteredProduct = filterProductList({
      filterPrice: refFilterState.rangePrice,
      filterCategory: refFilterState.selectedCategory,
      filterColor: refFilterState.selectedColor,
    });
  ...
  renderPagination = () => {
    ...
    for (let index = 0; index < products.length; index++) {
      ...
      const btn = (
        <button
          onClick={() => {
            this.onChangeSelectedPage(index);
          }}
          className={`button-pagination ${selectedPageStyle}`}
          key={index}
        >
          {index + 1}
        </button>
  ...
  renderProductList() {
    ...
    return (
      <div className="main_content">
        <div
          className="product_sorting_container product_sorting_container_top"
    ...
    return (
      <div>
        <div className="container product_section_container">
          <div
            className="col product_section clearfix"
            style={{ marginTop: 10 }}
          >
        ...
        >
          <i
            ...
            aria-hidden="true"
            style={{ marginTop: "5px", fontSize: 20, opacity: 0.5 }}
          ></i>
        </a>
        <ShippingInformation />
      </div>
